...
// Prefer project .env value; if system env points elsewhere (e.g. deepseek), use MiniMax directly
const rawBase = process.env.ANTHROPIC_BASE_URL || 'https://api.minimaxi.com/anthropic';
const ANTHROPIC_API_URL = (rawBase.includes('deepseek') ? 'https://api.minimaxi.com/anthropic' : rawBase) + '/v1/messages';
